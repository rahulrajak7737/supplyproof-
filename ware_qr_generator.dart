...
class Myqr1generator extends StatefulWidget {
  const Myqr1generator({Key? key}) : super(key: key);

  @override
  State<Myqr1generator> createState() => _Myqr1generatorState();
}

class _Myqr1generatorState extends State<Myqr1generator> {
  @override
