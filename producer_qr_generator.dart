...
class Myqr2generator extends StatefulWidget {
  const Myqr2generator({Key? key}) : super(key: key);

  @override
  State<Myqr2generator> createState() => _Myqr2generatorState();
}

class _Myqr2generatorState extends State<Myqr2generator> {
  @override
