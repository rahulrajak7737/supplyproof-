...
import 'package:supplyproof/location.dart';
import 'package:supplyproof/producer_qr_generator.dart';
          ...
          BottomNavigationBarItem(
            icon: IconButton(
                onPressed: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => MydashboardProducer()),
                  );
          ...
          BottomNavigationBarItem(
            icon: IconButton(
                onPressed: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Myqr2generator(),),
                  );
